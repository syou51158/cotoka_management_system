...
<body>
    ...
    <div class="container py-4">
        <ul class="booking-steps">
            <li class="active"><i class="fas fa-list"></i> コース選択</li>
        ...
        <div class="salon-card">
            ...
            <div class="text-center">
                <a href="public_booking/select_service.php?salon_id=<?php echo $salon_id; ?>" class="btn booking-btn">
                    コースを選択する <i class="fas fa-chevron-right ml-2"></i>
                </a>
            </div>
        </div>
    </div>
